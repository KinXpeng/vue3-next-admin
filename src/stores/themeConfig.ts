...
export const useThemeConfig = defineStore('themeConfig', {
  state: (): ThemeConfigState => ({
    themeConfig: {
       ...
       */
      // 默认菜单导航背景颜色
      menuBar: '#081526',//'#545c64',
      // 默认菜单导航字体颜色
      menuBarColor: '#ffffff',//'#eaeaea',
      // 默认菜单高亮背景色
       ...
       */
      // 默认分栏菜单背景颜色
      columnsMenuBar: '#081526',//'#545c64',
      // 默认分栏菜单字体颜色
      columnsMenuBarColor: '#ffffff',//'#eaeaea',
      // 是否开启分栏菜单背景颜色渐变
      ...
      isWartermark: false,
      // 水印文案
      wartermarkText: 'vue3-next-admin',
      ...
      globalTitle: 'vue3-next-admin',
      // 网站副标题（登录页顶部文字）
      globalViceTitle: 'vue3NextAdmin',
      // 网站副标题（登录页顶部文字）
